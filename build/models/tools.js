...
var blackBox_1 = require("./queriesTool/blackBox");
var fuzzyTrend_1 = require("./queriesTool/fuzzyTrend");
var tools = /** @class */ (function () {
    function tools() {
    }
    tools.prototype.BlackBox = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var min_price, max_price, review_score, product_category_name, connect, sql, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = blackBox_1.queriesBlackBox.BLACK_BOX_QUERY;
    ...
    tools.prototype.FuzzyTrend1 = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var order_approved_at_start, order_approved_at_End, connect, sql, res, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = fuzzyTrend_1.querysFuzzyTrend.FUZZY_TREND1_QUERY;
    ...
    tools.prototype.FuzzyTrend2 = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var order_approved_at_start, order_approved_at_End, connect, sql, res, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = fuzzyTrend_1.querysFuzzyTrend.FUZZY_TREND2_QUERY;
                        return [4 /*yield*/, connect.query(sql, [order_approved_at_start, order_approved_at_End])
                            //console.log(res);
                        ];
                    case 2:
    ...
    tools.prototype.FuzzyTrend3 = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var order_approved_at_start, order_approved_at_End, product_category_name, connect, sql, res, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = fuzzyTrend_1.querysFuzzyTrend.FUZZY_TREND3_QUERY;
                        return [4 /*yield*/, connect.query(sql, [
    ...
    tools.prototype.Trend = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var price, review_score, product_category_name, connect, sql, res, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    tools.prototype.Expect = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var price, review_score, product_category_name, connect, sql, res, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    tools.prototype.GoldenPattern = function (product) {
        return __awaiter(this, void 0, void 0, function () {
