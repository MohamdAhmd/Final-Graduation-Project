...
var controllers = __importStar(require("../../../controllers/user_mangment/group"));
...
routes.delete('/delete', (0, express_validator_1.check)('id').isNumeric(), controllers.deleteGroup);
//user routes
routes.post('/create', (0, express_validator_1.check)('group_name')
    .notEmpty()
    .isString()
