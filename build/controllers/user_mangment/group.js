...
exports.updateGroup = exports.deleteGroup = exports.create = exports.showByGroupName = exports.show = exports.index = void 0;
var group_1 = require("../../models/user_mangment/group");
var express_validator_1 = require("express-validator");
var info = new group_1.GROUPInfo();
...
exports.show = show;
var showByGroupName = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, group, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, info.showByName(req.body.name)];
            case 1:
                group = _a.sent();
                if (!group) {
                    return [2 /*return*/, res.status(404).json({
...
exports.showByGroupName = showByGroupName;
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, newGroup, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, info.create(req.body.group_name)];
            case 1:
                newGroup = _a.sent();
                return [2 /*return*/, res.json({
                        status: 'success',
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, info.deleteGroup(req.body.id)];
            case 1:
                deleted = _a.sent();
                if (!deleted) {
                    return [2 /*return*/, res.status(404).json({
