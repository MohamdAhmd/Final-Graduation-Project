...
var audit_1 = require("../models/audit/audit");
var database_1 = __importDefault(require("../database"));
var queryAudit_1 = require("../models/audit/queryAudit");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    auditQuery = queryAudit_1.queryList.AUDIT_QUERY;
                    return [4 /*yield*/, database_1.default.connect()];
                case 2:
                    connect = _a.sent();
                    return [4 /*yield*/, connect.query(auditQuery, [
                            audit.auditAction,
                            JSON.stringify(audit.data),
                            audit.status,
                            audit.error,
